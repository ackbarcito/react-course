...
function bodyLeaders(arrayLeaders) {
  const leaders = arrayLeaders.leaders.map((leader) => {
    return (
      <Media>
  ...
  } else if (arrayLeaders.errMess) {
    return (
      <div className="container">
        <div className="row">
          <h4>{arrayLeaders.errMess}</h4>
        </div>
      </div>
    );
  } else return leaders;
  ...
  return (
    <div className="container">
      ...
      <div className="row row-content">
        ...
        <div className="col-12">{bodyLeaders(props.leaders)}</div>
      </div>
    </div>
  );
}
